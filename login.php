              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1">Bienvenido a <a href="index"> WebClin</a></h4>
                  </div>
                  ...
                  <form action="php/controlador/verificarUsuario.php" method="POST">
                    ...
                    <div class="text-center pt-1 mb-5 pb-1 mt-5">
                      <button class="btn btn-primary btn-block fa-lg mb-3 col-12" href="crud.php" type="submit">INICIAR
                        SESION</button>

                      <a class="text-muted" href="restablecerPassword">Olvidaste tu
                        contraseña?</a>
                    </div>

                    <div class="d-flex align-items-center justify-content-center pb-4">
                      <p class="mb-0 me-2">No tienes una cuenta?</p>
                      <a class="text-muted" style="cursor:pointer" href="registro">crear
                        cuenta</a>
                    </div>
                  </form>
